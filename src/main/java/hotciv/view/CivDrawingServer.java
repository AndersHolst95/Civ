...
public class CivDrawingServer implements Drawing, GameObserver {
    ...
    protected CityProxy cityProxy;
    protected TileProxy tileProxy;
    ...
    public CivDrawingServer( DrawingEditor editor, Game game, UnitProxy unitProxy, TileProxy tileProxy, CityProxy cityProxy) {
        super();
